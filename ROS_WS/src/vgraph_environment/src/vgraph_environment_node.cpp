...
class Vgraph {
  public :
    Vgraph(int argc, char** argv) {
      ...
      std::string object_path = "/home/chris/git/Multi-Layer-Motion-Planning/ROS_WS/src/vgraph_environment/src/obstacles.txt";
      ...
      std::string goal_path = "/home/chris/git/Multi-Layer-Motion-Planning/ROS_WS/src/vgraph_environment/src/goal.txt";
