...
class Vgraph():
	...
	#obstacles = load_obstacles('world_obstacles.txt')
	obstacles = [[[100, 0], [100, 50], [150, 0]], [[225, 25], [275, 25], [325, -25], [275, -75]], [[450, 30], [450, 130], [525, 130], [525, 30]], [[400, -50], [400, -100], [425, -50]], [[300, 100], [300, 150], [350, 150], [350, 100]]]        
	grown_obstacles = grow_obstacles(obstacles)
	#goal = load_goal("~/Desktop/rbe500-ros/src/Visibility_graph/vgraph/data/goal.txt")
	goal = [600, 0]
	start = [0.0, 0.0]
