...
int main() {
  ...
  fptr.open("obstacles.txt");       // Open file with your numbers as input.
  ...
  std::vector<std::vector<std::pair<int, int>>> obstacles(num_obs);  //Vector to store coordinates in an array
  ...
  fptr.close(); // Clean up. Close file.
  //******************************//LOAD OBSTACLES FROM TXT FILE//******************************//


  //******************************LOAD GOAL FROM TXT FILE******************************//
  std::fstream gptr;             // File pointer
  gptr.open("goal.txt");            // Open file with your numbers as input
